...
public class Client 
{
    ...
    private static double downloadSpeedMbps = 5.0;	// i think this is the max speed, otherwise it filters based on my speed and i can't get the whole video list
     ...
     */
    private static void streamVideo(BufferedReader in, String protocol) throws IOException
    {
    	ProcessBuilder builder;
    	File ffplay = FFmpegLoader.getFFtoolExecutable("ffplay");	// Get a file reference using my loader

    	switch (protocol)
    	{
        case "UDP":
            builder = new ProcessBuilder(
            		ffplay.getAbsolutePath(),
     ...
     */
    private static void downloadVideo(BufferedReader in, String protocol, String downloadFilePath, double expectedDownloadTime) throws IOException
    {
    	ProcessBuilder builder;
    	File ffmpeg = FFmpegLoader.getFFtoolExecutable("ffmpeg");	// Get a file reference using my loader

    	switch (protocol)
    	{
        case "UDP":
            builder = new ProcessBuilder(ffmpeg.getAbsolutePath(),
