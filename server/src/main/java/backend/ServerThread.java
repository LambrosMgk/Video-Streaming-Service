...
public class ServerThread extends Thread 
{
     ...
     */
    private String getVideoDuration(String videoName) throws IOException
    {
    	...
    	File ffprobe = FFmpegLoader.getFFtoolExecutable("ffprobe");	// Get a file reference using my loader
    	ProcessBuilder builder = new ProcessBuilder(
    			ffprobe.getAbsolutePath(), "-v", "error",
     ...
     */
    private String getVideoBitrate(String videoName) throws IOException
    {
    	File video = findVideo(videoName);
    	if(video == null)
    	{
     ...
     */
    private String getVideoSize(String videoName) throws IOException
    {
    	File video = findVideo(videoName);
    	if(video == null)
    	{
     ...
     */
    private void uploadVideoToClient(PrintWriter out, String videoName, String vidDuration, String clientProtocol, String transferMethod) throws IOException
    {
        ...
        switch (clientProtocol) 
        {
            case "UDP":
                ...
                builder = new ProcessBuilder(
                		ffmpeg.getAbsolutePath(), "-i", inputFilePath,
                        "-c:a", "aac",
                        "-f", "mpegts",
                        destination
                );
